...
const SharingButton = ({ name, url }: SharingButtonProps) => {
	return (
		<>
			{name == 'twitter' && (
				<Link href={url} passHref>
					<a
						className={`${styles.share_btn} ${styles.twitter}`}
						target='_blank'
			...
			{name == 'facebook' && (
				<Link href={url} passHref>
					<a
						className={`${styles.share_btn} ${styles.facebook}`}
						target='_blank'
						rel='nofollow noopener'>
						<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
			...
			{name == 'reddit' && (
				<Link href={url} passHref>
					<a
						className={`${styles.share_btn} ${styles.reddit}`}
						target='_blank'
						rel='nofollow noopener'>
						<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
			...
			{name == 'whatsapp' && (
				<Link href={url} passHref>
					<a
						className={`${styles.share_btn} ${styles.whatsapp}`}
						target='_blank'
						rel='nofollow noopener'>
						<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
			...
			{name == 'hackernews' && (
				<Link href={url} passHref>
					<a
						className={`${styles.share_btn} ${styles.hackernews}`}
						target='_blank'
						rel='nofollow noopener'>
			...
			{name == 'telegram' && (
				<Link href={url} passHref>
					<a
						className={`${styles.share_btn} ${styles.telegram}`}
						target='_blank'
						rel='nofollow noopener'>
						<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
			...
			{name == 'mail' && (
				<Link href={url} passHref>
					<a
						className={`${styles.share_btn} ${styles.mail}`}
						target='_blank'
						rel='nofollow noopener'>
						<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
